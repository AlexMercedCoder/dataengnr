...
description: "A guide to snapshot expiration in Apache Iceberg, the table maintenance operation that removes historical snapshots and their associated data files to reclaim storage space while preserving configurable data retention windows."
date: 2026-05-17
